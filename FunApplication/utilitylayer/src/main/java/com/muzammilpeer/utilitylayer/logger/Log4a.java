package com.muzammilpeer.utilitylayer.logger;
...
public class Log4a {
    ...
    public static String getStackTraceString(Error e) {
        return Log.getStackTraceString(e);
    }
    ...
    public static void printError(Error e) {
        Log4a.e("printError ", e == null || e.getMessage() == null ? "Exception" : e.getMessage());
        Log4a.e("printErrorStack ", getStackTraceString(e));
    }
